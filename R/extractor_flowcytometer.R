...
# CREATE FLOW DATA FRAME AND FILL WITH UNGATED COUNT ----------------------
  ...
  fsa <- transform(
    fsa,
    `FL1-H` = truncateTransform( "truncate at 1", a = 1 )(`FL1-H`),
    `FL3-H` = truncateTransform( "truncate at 1", a = 1 )(`FL3-H`),
    `FSC-A` = truncateTransform( "truncate at 1", a = 1 )(`FSC-A`),
    `SSC-A` = truncateTransform( "truncate at 1", a = 1 )(`SSC-A`),
    `Width` = truncateTransform( "truncate at 1", a = 1 )(`Width`)
  )
  # log transform
  fsa <- transform(
    fsa,
    `FL1-H` = logTransform( transformationId = "log10-transformation", logbase = 10, r = 1, d = 1 )(`FL1-H`),
    `FL3-H` = logTransform( transformationId = "log10-transformation", logbase = 10, r = 1, d = 1 )(`FL3-H`),
    `FSC-A` = logTransform( transformationId = "log10-transformation", logbase = 10, r = 1, d = 1 )(`FSC-A`),
    `SSC-A` = logTransform( transformationId = "log10-transformation", logbase = 10, r = 1, d = 1 )(`SSC-A`),
    `Width` = logTransform( transformationId = "log10-transformation", logbase = 10, r = 1, d = 1 )(`Width`)
  )
