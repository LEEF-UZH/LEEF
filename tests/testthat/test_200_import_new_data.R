...
dir.create( testdir )
file.copy(
  from = system.file( "sample_data", "test_200_import_new_data", "config.yml", package = "LEEF.Data" ),
  to = testdir
)
setwd( testdir )
initialize_db( )
...
file.copy(
  from = list.files( system.file( "sample_data", "test_200_import_new_data", "ToBeImported", package = "LEEF.Data" ), full.names = TRUE ),
